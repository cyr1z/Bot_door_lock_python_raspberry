...
#             text = part["Text"]
#             date = datetime.fromtimestamp(part["EffectiveEpochDate"]).strftime(
#                 "%d/%m/%Y %H:%M"
#             )
#             end_date = datetime.fromtimestamp(part["EndEpochDate"]).strftime(
#                 "%d/%m/%Y %H:%M"
#             )
...
#             if i["Value"]:
#                 air_string += (
#                     f" {pollen_translate[i['Name']]}: {i['Category']} ({i['Value']})\n"
#                 )
#         return air_string
#
#     @property
...
#             wind_gust_direction_arrow_icon = wind_direction_arrow[
#                 wind_gust_direction_text_en
#             ]
#         else:
...
#         result += (
#             f", порывы {wind_gust_direction_text} {wind_gust_direction_arrow_icon}"
#         )
